...

{
  ...
  "description": "Creates a Session String with a Session ID which is a Linux timestamp in seconds when the session started, Session Number, and Update Timestamp.",
  "containerContexts": [
    "SERVER"
  ]
}
